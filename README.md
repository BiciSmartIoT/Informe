...
<img src="/assets/images/Chapter-1/logoupc1.png" alt="Logo UPC" width="180">

### **Universidad Peruana de Ciencias Aplicadas**

### **Facultad De Ingenieria**

### **Curso:** 1ASI0572 - Desarollo De Soluciones IOT
...
| Integrantes                          | Tarea asignada |
|--------------------------------------|----------------|
| Bustamante Leveau, Cameron Charllotte | - Correcciones del Chapter IV <br> - Actualización de arquitectura y Structurizr <br> - Desarrollo de Sprint 1 |
| Uribe Livia, Renzo Sebastián | - Correcciones generales del documento <br> - Desarrollo de Wireflow y User Flow Diagrams <br> - Capítulo VI y conclusiones |
| Espinoza Quijandria, Oscar Leonardo | - Correcciones de Context Mapping <br> - Desarrollo de arquitectura y Sprint 1 |
...
![Insights - Network Graph](./assets/images/Chapter-1/Network-Graph.png)
...
![Insights - Contributors](./assets/images/Chapter-1/insights-contributor.png)
...
![Insights - Commits](./assets/images/Chapter-1/insights-commits.png)
...
#### 4.2.2. Bounded Context: Providing
...
#### 4.2.3. Bounded Context: Payments
...
#### 4.2.4. Bounded Context: IoT & Device Control
...
#### 4.2.5. Bounded Context: Tracking & Monitoring
...
|------------|-------------|--------------|
| U20231a804 — Bustamante Leveau, Cameron Charllotte ![Integrante-Cameron](/assets/images/Chapter-1/foto_cameron.png) |  Soy estudiante de la Universidad Peruana de Ciencias Aplicadas (UPC) y actualmente curso el octavo ciclo de la carrera de Ingeniería de Software. Tengo 21 años y me interesa el desarrollo de soluciones tecnológicas que combinen innovación, usabilidad y eficiencia.|Puedo aportar con mis conocimientos en desarrollo web (HTML, CSS, JavaScript, React, Node.js, Vue.js), así como en bases de datos (MySQL, SQL Server, MongoDB) y desarrollo móvil con Android Studio (Kotlin/Jetpack Compose). Además, tengo experiencia en gestión de proyectos académicos, trabajo en equipo y un alto dominio de Microsoft Office. |
| U202311745 — Uribe Livia, Renzo Sebastián ![Integrante-Renzo](/assets/images/Chapter-1/Renzo.png) | Cuento con una sólida formación en desarrollo Full Stack, con dominio en tecnologías como React, Vue.js y Node.js, además de experiencia en bases de datos relacionales y no relacionales (SQL y MongoDB). Mi perfil técnico se complementa con habilidades en desarrollo móvil nativo usando Kotlin y Jetpack Compose. Me distingo por mi enfoque proactivo y mi capacidad para gestionar proyectos académicos con éxito, siempre orientado a crear soluciones digitales innovadoras en el ámbito de la inteligencia artificial y la productividad. | Puedo aportar con conocimientos en desarrollo Full Stack utilizando tecnologías como React, Vue.js, Node.js, HTML, CSS y JavaScript, además de experiencia en bases de datos relacionales y no relacionales (SQL y MongoDB). Asimismo, tengo conocimientos en desarrollo móvil con Kotlin y Jetpack Compose, integración de APIs, diseño de interfaces y gestión de proyectos tecnológicos orientados a soluciones innovadoras y productivas. |
| U202311842 — Espinoza Quijandria, Oscar Leonardo ![Integrante-Oscar](/assets/images/Chapter-1/Oscar.jpg) | Descripción: Tengo 20 años y soy estudiante de Ingeniería de Software con una fuerte orientación al desarrollo de soluciones tecnológicas. Me caracterizo por mi enfoque analítico y mi capacidad para estructurar sistemas de manera organizada, especialmente en el diseño de arquitecturas y modelado de software. Me gusta trabajar en equipo, aportar ideas técnicas y asegurar que las soluciones sean escalables y bien definidas. Además, tengo interés en el desarrollo backend y en la integración de sistemas, lo que me permite contribuir en la construcción de soluciones completas. | Manejo tecnologías como Java y Spring Boot para el desarrollo backend, así como conceptos de arquitectura de software como Domain-Driven Design (DDD) y diseño de APIs REST. Tengo experiencia en modelado de sistemas mediante diagramas como Context, Container y Deployment, y conocimientos en integración con servicios externos y sistemas IoT. Además, estoy familiarizado con bases de datos relacionales y el diseño de estructuras eficientes para aplicaciones escalables.
| U202311828 — Landauri Preciado, Stephano Mayrzon ![Integrante-Stephano](/assets/images/Chapter-1/Stephano-Landauri.jpg) |Tengo 20 años y soy un estudiante con fuerte orientación al trabajo en equipo. Me caracterizo por impulsar las habilidades de mis compañeros y mantener una actitud colaborativa en cada etapa del proyecto. Además, tengo facilidad para detectar las necesidades del usuario, lo que me permite aportar una perspectiva centrada en el cliente al momento de tomar decisiones en el equipo.| Manejo lenguajes como Java y C++, con conocimientos en Python, y actualmente me encuentro aprendiendo Kotlin. Complemento estas habilidades con gestión de bases de datos, lo que me permite participar tanto en el diseño como en la implementación de soluciones completas.
| U202220219 — Belahonia Miranda, Fabrisio Andre ![Integrante-Fabrisio](/assets/images/Chapter-1/fafafa.jpeg) |Estudiante de Ingeniería de Software de 7mo ciclo, con interés en el área de ciberseguridad. Se caracteriza por ser responsable, ordenado y empático, con buena capacidad para el trabajo en equipo y resolución de problemas. Busca fortalecer sus habilidades en entornos tecnológicos y de seguridad informática. |Puedo aportar con mis conocimientos en ciberseguridad, especialmente en enfoques de Blue Team y Red Team, incluyendo reconocimiento web, análisis de vulnerabilidades y explotación básica de redes.|

## 1.2. Solution Profile

## 1.2.1. Antecedentes y problemática

Para el análisis de los antecedentes y la problemática se ha empleado la técnica de las 5 W’s y 2 H’s, sustentando la información con datos estadísticos y reportes relacionados con la seguridad ciudadana y el uso de bicicletas en entornos urbanos.

De acuerdo con la Municipalidad Metropolitana de Lima y diversos reportes de seguridad ciudadana, el robo de bicicletas ha incrementado en los últimos años debido al crecimiento de la micromovilidad y al mayor uso de bicicletas como medio de transporte sostenible. Asimismo, estudios de movilidad urbana señalan que muchos usuarios dejan de utilizar bicicletas por temor al robo o por falta de mecanismos de protección y monitoreo en tiempo real.

Además, según la Organización Mundial de la Salud (OMS), los accidentes de tránsito relacionados con ciclistas representan un problema importante en zonas urbanas, especialmente en contextos donde no existen mecanismos de respuesta rápida o asistencia inmediata ante emergencias.

### Análisis 5W + 2H

**¿Quién? (Who):**  
Usuarios urbanos que utilizan bicicletas como medio de transporte, estudiantes universitarios, trabajadores, deportistas y personas que realizan actividades al aire libre.

**¿Qué ocurre? (What):**  
Existe un incremento en los robos de bicicletas y una alta exposición a accidentes o situaciones de emergencia sin asistencia inmediata.

**¿Dónde? (Where):**  
Principalmente en zonas urbanas, estacionamientos públicos, alrededores de universidades, centros laborales y rutas de ciclismo.

**¿Cuándo? (When):**  
Durante todo el día, especialmente cuando los usuarios dejan estacionadas sus bicicletas o realizan recorridos largos en zonas alejadas.

**¿Por qué sucede? (Why):**  
Porque los sistemas tradicionales de seguridad son pasivos y no cuentan con monitoreo en tiempo real, geolocalización ni alertas automáticas.

**¿Cómo sucede? (How):**  
Los robos suelen ocurrir mediante la vulneración de candados tradicionales, mientras que los accidentes pueden suceder sin que el usuario tenga posibilidad de solicitar ayuda inmediata.

**¿Cuánto afecta? (How Much):**  
Genera pérdidas económicas, desconfianza en el uso de bicicletas y riesgos físicos para los usuarios.
...
Hemos observado que los usuarios urbanos y ciclistas enfrentan altos niveles de inseguridad debido al robo de bicicletas y la falta de mecanismos de asistencia inmediata en situaciones de emergencia. Los sistemas tradicionales de protección, como candados físicos, no brindan monitoreo ni alertas en tiempo real.

¿Cómo podríamos diseñar una solución IoT inteligente y accesible que permita rastrear bicicletas en tiempo real, detectar movimientos sospechosos y alertar automáticamente a contactos de emergencia ante incidentes o accidentes?

---

### 1.2.2.2. Lean UX Assumptions

1. Creemos que los usuarios estarán dispuestos a utilizar una solución IoT si esta les brinda seguridad y monitoreo en tiempo real.
2. Creemos que las notificaciones instantáneas incrementarán la percepción de protección y control del usuario.
3. Creemos que una integración sencilla entre hardware y aplicación móvil facilitará la adopción del producto.
4. Creemos que las funciones de geolocalización y alertas SOS aportarán valor diferencial frente a soluciones tradicionales.

---

### 1.2.2.3. Lean UX Hypothesis Statements

- Creemos que, al implementar monitoreo y rastreo en tiempo real mediante IoT, lograremos reducir la sensación de inseguridad de los usuarios. Lo sabremos cuando al menos el 70% de los usuarios piloto indiquen sentirse más seguros utilizando la bicicleta.

- Creemos que, al incorporar alertas automáticas de emergencia, lograremos incrementar la confianza y retención de usuarios. Lo sabremos cuando el índice de retención sea superior al 80% después de los primeros tres meses de uso.

---

## 1.2.2.4. Propuesta de Valor

### Propuesta de Valor de BiciSmartIOT

BiciSmartIOT ofrece una solución integral de seguridad para bicicletas basada en tecnología IoT, permitiendo a los usuarios monitorear y proteger sus bicicletas en tiempo real mediante geolocalización, alertas inteligentes y funciones de emergencia.

La propuesta de valor se centra en:

- Incrementar la seguridad de los ciclistas mediante rastreo GPS en tiempo real.
- Reducir el riesgo de robo gracias a alertas automáticas y monitoreo continuo.
- Brindar asistencia rápida en situaciones de emergencia mediante alertas SOS.
- Facilitar una experiencia accesible y sencilla mediante integración con una aplicación móvil intuitiva.
- Promover el uso de transporte sostenible aumentando la confianza de los usuarios.
...
| :---- | :---- | ----- | :---- | :---- | :---- |
| Perfil | Overview   | Sistema IoT de seguridad para bicicletas con monitoreo en tiempo real, detección de robos y alertas inteligentes mediante app móvil | Red de bicicletas compartidas con estaciones fijas | App de micromovilidad sin estaciones | Empresa global de micromovilidad |
|  | Ventaja competitiva | • Rastreo GPS 24/7 <br>• Alertas de robo en tiempo real <br>• Detección de movimiento sospechoso <br>• Integración hardware + app <br>• GeoFence inteligente | • Infraestructura física estable <br>• Disponibilidad constante | • Uso flexible sin estaciones | • Escala global y tecnología avanzada |
| Perfil de Marketing | Mercado objetivo  | Estudiantes universitarios y arrendatarios | Público urbano | Jóvenes urbanos | Público global |
| Perfil de Producto | • Productos & Servicios  | Dispositivo IoT + app de monitoreo, alertas y seguridad | Bicicletas compartidas | Scooters eléctricos | Scooters y bicis |
|  | Precios & Costos  | Modelo: dispositivo + suscripción IoT | Planes fijos | Pago por minuto | Pago por minuto |
|  | Canales de distribución | App móvil + hardware | App + estaciones | App | App |
| Análisis SWOT | Fortalezas | • Seguridad activa (no solo movilidad) <br>• Diferenciación tecnológica IoT | • Respaldo institucional | • Flexibilidad | • Marca global |
|  | Debilidades | • Hardware requiere adopción inicial | • Infraestructura costosa | • Problemas financieros | • Costos altos |
|  | Oportunidades | • Crecimiento del ciclismo urbano <br>• Necesidad de seguridad | • Expansión urbana | • Retorno al mercado | • Expansión LATAM |
|  | Amenazas | • Competidores tecnológicos <br>• Regulación | • Cambios políticos | • Seguridad vial | • Rechazo urbano |
...
##### **Diferenciación por seguridad IoT**
A diferencia de los competidores, BiciSmartIOT no se enfoca en alquilar vehículos, sino en protegerlos mediante:
- Monitoreo GPS en tiempo real  
- Alertas automáticas ante robos  
- Detección de movimiento sospechoso  

##### **Protección del activo y del usuario**
- Seguridad de la bicicleta (anti-robo)
- Seguridad del usuario (alertas y monitoreo)

##### **Integración tecnológica**
- Hardware IoT discreto
- App móvil intuitiva
- Conectividad en tiempo real (IoT + Bluetooth)

##### **Modelo escalable**
- Venta del dispositivo
- Suscripción mensual por conectividad

---

#### **Tácticas**

- Pilotos en universidades  
- Validación con arrendatarios  
- Feedback continuo desde la app  
- Lanzamiento con descuentos iniciales  
...
| Link a las entrevistas  |[enlace de video de las entrevistas](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202310601_upc_edu_pe/ESS8nMNW8DtHtgz9a86ulzQBBr3fUWxfJBCfo8i_5RCgIw?e=Opy84t&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)  |
...
| Término | Significado |
|--------|------------|
| IoT Device | Dispositivo instalado en la bicicleta que envía datos |
| GPS Tracking | Ubicación en tiempo real |
| GeoFence | Zona de seguridad virtual |
| Motion Detection | Detección de movimiento |
| Anti-theft Alert | Alerta de robo |
| Real-time Notification | Notificación inmediata |
| Remote Monitoring | Monitoreo remoto desde app |
| Smart Security | Seguridad inteligente basada en sensores |
| IoT Connectivity | Conectividad del dispositivo |
| Mobile App | Aplicación de control del usuario |

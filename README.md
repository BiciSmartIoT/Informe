...
- **Structurizr**: Plataforma utilizada para la creación del modelo C4 en sus distintos niveles (contexto, contenedores y componentes), trabajando en conjunto con Visual Studio Code.
